export default function Banner() {
    return (
        <section className="banner bg-blue-600 text-white gap-5 sm:gap-2 p-6 pb-5 flex flex-col items-center sm:flex-row 2xl:px-16 2xl:py-4 2xl:pt-8">
            <div className="gap-5 flex">
                <img src="/images/best-prices.svg" alt="best prices" />
