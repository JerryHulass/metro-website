    ...
    return (
        <section className="banner bg-blue-600 text-white p-6 flex flex-col items-center sm:flex-row">
            <div className="gap-5 flex">
                <img src="/public/images/best-prices.svg" alt="best prices" className=""/>
                <div className="pb-5">
                    <h1>Best Prices</h1>
            ...
            <div className="gap-5 flex">
                <img src="/public/images/guarantee.svg" alt="guarantee" />
                <div className="pb-5" >
                    <h1>100% Guarantee</h1>
            ...
            <div className="gap-5 flex">
                <img src="/public/images/certified.svg" alt="certified" />
                <div className="pb-5">
